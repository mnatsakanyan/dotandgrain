    ...
    document.getElementById('woocs-sd-create').addEventListener('click', function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (id) {
                ...
                btn_delete.className = 'woocs-panel-button dashicons-before dashicons-dismiss';
